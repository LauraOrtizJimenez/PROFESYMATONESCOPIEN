...
{
    /// <inheritdoc />
    public partial class PlayerGameIdNullable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    CurrentTurnPlayerIndex = table.Column<int>(type: "int", nullable: false),
                    CurrentTurnPhase = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BottomPosition = table.Column<int>(type: "int", nullable: false),
                    TopPosition = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BoardId = table.Column<int>(type: "int", nullable: false),
                    HeadPosition = table.Column<int>(type: "int", nullable: false),
                    TailPosition = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromPosition = table.Column<int>(type: "int", nullable: false),
                    ToPosition = table.Column<int>(type: "int", nullable: false),
                    SnakeId = table.Column<int>(type: "int", nullable: true),
                    LadderId = table.Column<int>(type: "int", nullable: true),
                    FinalPosition = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiceRolls_GameId_PlayerId_RolledAt",
                table: "DiceRolls",
                columns: new[] { "GameId", "PlayerId", "RolledAt" });
